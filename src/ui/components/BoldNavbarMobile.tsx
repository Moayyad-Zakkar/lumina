...
/*
 * Documentation:
 * Bold navbar mobile — https://app.subframe.com/3c939b2b64b7/library?component=Bold+navbar+mobile_6c2df348-8393-45ab-9b9a-46d6d1131fbc
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        "group/7fb2f0a4 flex h-8 cursor-pointer flex-col items-center justify-center gap-4 rounded-full px-4",
